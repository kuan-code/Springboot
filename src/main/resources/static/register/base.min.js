if (!function (a, b, c) {
    ...
    var n = b.documentElement, o = "svg" === n.nodeName.toLowerCase(),
...
+function (a) {
    ...
    var d = "textareaAutoSize", e = "plugin_" + d, f = function (a) {
    ...
    function b(b, d) {
        return this.each(function () {
            var e = a(this), f = e.data("bs.menu"), g = a.extend({}, c.DEFAULTS, e.data(), "object" == typeof b && b);
            f || e.data("bs.menu", f = new c(this, g)), "string" == typeof b ? f[b](d) : g.show && f.show(d)
        })
    }

    var c = function (b, c) {
        this.ignoreBackdropClick = !1, this.isShown = null, this.options = c, this.originalBodyPad = null, this.scrollbarWidth = 0, this.$backdrop = null, this.$body = a(document.body), this.$element = a(b), this.$dialog = this.$element.find(".menu-scroll")
    };
    ...
    c.DEFAULTS = a.extend({}, a.fn.modal.Constructor.DEFAULTS, {}), c.TRANSITION_DURATION = 300, c.TRANSITION_DURATION_BACKDROP = 150, c.prototype = a.extend({}, a.fn.modal.Constructor.prototype), c.prototype.backdrop = function (b) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            e ? this.$backdrop.one("bsTransitionEnd", b).emulateTransitionEnd(c.TRANSITION_DURATION_BACKDROP) : b()
        } else if (!this.isShown && this.$backdrop) {
            this.$backdrop.removeClass("in");
            var f = function () {
                d.removeBackdrop(), b && b()
            };
            a.support.transition ? this.$backdrop.one("bsTransitionEnd", f).emulateTransitionEnd(c.TRANSITION_DURATION_BACKDROP) : f()
        } else b && b()
    }, c.prototype.hide = function (b) {
        b && b.preventDefault(), b = a.Event("hide.bs.menu"), this.$element.trigger(b), this.isShown && !b.isDefaultPrevented() && (this.isShown = !1, this.escape(), a(document).off("focusin.bs.modal"), this.$element.removeClass("in").off("click.dismiss.bs.menu").off("mouseup.dismiss.bs.menu"), this.$dialog.off("mousedown.dismiss.bs.menu"), a.support.transition ? this.$element.one("bsTransitionEnd", a.proxy(this.hideModal, this)).emulateTransitionEnd(c.TRANSITION_DURATION) : this.hideModal())
    }, c.prototype.hideModal = function () {
        var a = this;
        this.$element.hide(), this.backdrop(function () {
            a.$element.trigger("hidden.bs.menu")
        })
    }, c.prototype.show = function (b) {
        var d = this, e = a.Event("show.bs.menu", {relatedTarget: b});
        this.$element.trigger(e), this.isShown || e.isDefaultPrevented() || (this.isShown = !0, this.escape(), this.$element.on("click.dismiss.bs.menu", '[data-dismiss="menu"]', a.proxy(this.hide, this)), this.$dialog.on("mousedown.dismiss.bs.menu", function () {
            d.$element.one("mouseup.dismiss.bs.menu", function (b) {
                a(b.target).is(d.$element) && (d.ignoreBackdropClick = !0)
            })
        }), this.backdrop(function () {
            var e = a.support.transition;
    ...
    a.fn.menu = b, a.fn.menu.Constructor = c, a.fn.menu.noConflict = function () {
        return a.fn.menu = d, this
    }, a(document).on("click.bs.menu.data-api", '[data-toggle="menu"]', function (c) {
        var d = a(this), e = d.attr("href"), f = a(d.attr("data-target") || e && e.replace(/.*(?=#[^\s]+$)/, "")),
            g = f.data("bs.menu") ? "toggle" : a.extend({remote: !/#/.test(e) && e}, f.data(), d.data());
        d.is("a") && c.preventDefault(), f.one("show.bs.menu", function (a) {
            a.isDefaultPrevented() || (f.attr("tabindex", "-1"), f.one("hidden.bs.menu", function () {
                d.is(":visible") && d.trigger("focus")
            }))
        }), b.call(f, g, this)
    })
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.pickdate"),
    ...
    c.DEFAULTS = {
        ...
        this.$element.pickadate({
            ...
            max: b.options.max,
            min: b.options.min,
            monthsFull: b.options.monthsFull,
            monthsShort: b.options.monthsShort,
            onClose: b.options.onClose,
            onOpen: b.options.onOpen,
            onRender: b.options.onRender,
            onSet: b.options.onSet,
            onStart: b.options.onStart,
            onStop: b.options.onStop,
            selectMonths: b.options.selectMonths,
            selectYears: b.options.selectYears,
            today: b.options.today,
            weekdaysFull: b.options.weekdaysFull,
            weekdaysShort: b.options.weekdaysShort
        });
        var c = this.$element.pickadate("picker"), d = (c.$node, c.$root);
        c.on({
            close: function () {
                a(document.activeElement).blur()
            }, open: function () {
                a(".picker__date-display", d).length || b.display(c, d, "highlight")
            }, set: function () {
                null !== c.get("select") && b.display(c, d, "select")
            }
        })
    };
    var d = a.fn.pickdate;
    a.fn.pickdate = b, a.fn.pickdate.Constructor = c, a.fn.pickdate.noConflict = function () {
        return a.fn.pickdate = d, this
    }
}(jQuery), function (a) {
    "use strict";
    ...
    function b(b) {
        return this.each(function () {
            var d = a(document.body), e = d.data("bs.snackbar"), f = a.extend({}, c.DEFAULTS, b);
            e ? a(".snackbar-inner").length && !a(".snackbar-inner.old").length ? (a(".snackbar-inner.in").addClass("old"), e.hide(), a.support.transition ? a(document).one("bsTransitionEnd", ".snackbar-inner.old", function () {
                d.data("bs.snackbar", e = new c(f)), e.show()
            }) : (d.data("bs.snackbar", e = new c(f)), e.show())) : a(".snackbar-inner").length || (d.data("bs.snackbar", e = new c(f)), e.show()) : (d.data("bs.snackbar", e = new c(f)), e.show())
        })
    }

    var c = function (b) {
        this.options = b, this.$element = a('<div class="snackbar-inner">' + this.options.content + "</div>")
    };
    c.DEFAULTS = {
        alive: 6e3, content: "&nbsp;", hide: function () {
        }, show: function () {
        }
    }, c.prototype.fbtn = function (b) {
        if (a(window).width() < 768 && a(".fbtn-container").length) {
            var c = "translateY(-" + b + "px)";
            a(".fbtn-container").css({"-webkit-transform": c, transform: c})
        }
    }, c.prototype.hide = function () {
        var b = this;
        this.$element.removeClass("in"), clearTimeout(this.$element.data("timer")), a.support.transition ? this.$element.one("bsTransitionEnd", function () {
            b.options.hide(b.options), b.$element.remove()
        }) : (b.options.hide(b.options), b.$element.remove()), this.fbtn("0")
    }, c.prototype.show = function () {
        var b = this;
        a(".snackbar").length || a(document.body).append('<div class="snackbar"></div>'), this.$element.appendTo(".snackbar").show().addClass(function () {
            return b.$element.on("click", '[data-dismiss="snackbar"]', function () {
                b.hide()
            }), b.$element.data("timer", setTimeout(function () {
                b.hide()
            }, b.options.alive)), b.$element.on("mouseenter", function () {
                clearTimeout(b.$element.data("timer"))
            }).on("mouseleave", function () {
                b.$element.data("timer", setTimeout(function () {
                    b.hide()
                }, b.options.alive))
            }), b.options.show(b.options), "in"
        }), this.fbtn(this.$element.outerHeight())
    };
    var d = a.fn.snackbar;
    a.fn.snackbar = b, a.fn.snackbar.Constructor = c, a.fn.snackbar.noConflict = function () {
        return a.fn.snackbar = d, this
    }
}(jQuery), function (a) {
    "use strict";
    a.fn.tabSwitch = function (b) {
        var c = a(this), d = c.closest(".tab-nav"), e = a(".tab-nav-indicator", d), f = c.offset().left,
            g = d.offset().left, h = d.outerWidth();
        if (void 0 !== b && void 0 !== b[0]) {
            var i = b.offset().left;
            e.css({
                left: i - g,
                right: g + h - i - b.outerWidth()
            }), b.offset().left > f && (e.addClass("reverse"), e.one("webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend", function () {
                e.removeClass("reverse")
            }))
        }
        return e.addClass("animate").css({
            left: f - g,
            right: g + h - f - c.outerWidth()
    ...
    $(".tab-nav").each(function () {
        ...
        $(a.target).tabSwitch($(a.relatedTarget))
    })
}), function (a) {
    "use strict";
    ...
    function c(b) {
        return this.each(function () {
            var c = a(this), e = c.data("bs.tile"), f = a.extend({}, d.DEFAULTS, c.data(), "object" == typeof b && b);
            !e && f.toggle && /show|hide/.test(b) && (f.toggle = !1), e || c.data("bs.tile", e = new d(this, f)), "string" == typeof b && e[b]()
        })
    }

    var d = function (b, c) {
        this.options = a.extend({}, d.DEFAULTS, c), this.transitioning = null, this.$element = a(b), this.options.parent && (this.$parent = this.getParent()), this.options.toggle && this.toggle()
    };
    if (!a.fn.collapse) throw new Error("Menu requires Bootstrap collapse.js");
    d.DEFAULTS = {
        keyboard: !0,
        toggle: !0
    }, d.TRANSITION_DURATION = 150, d.prototype = a.extend({}, a.fn.collapse.Constructor.prototype), d.prototype.escape = function () {
        this.$element.hasClass("in") && this.options.keyboard ? a(document).on("keydown.dismiss.bs.tile", a.proxy(function (a) {
            27 == a.which && this.hide()
        }, this)) : this.$element.hasClass("in") || this.$element.off("keydown.dismiss.bs.tile")
    }, d.prototype.hide = function () {
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                var e = function () {
                    this.transitioning = 0, this.$element.removeClass("collapsing").addClass("collapse").trigger("hidden.bs.tile"), this.escape()
                };
                return a.support.transition ? void this.$element[c](0).one("bsTransitionEnd", a.proxy(e, this)).emulateTransitionEnd(d.TRANSITION_DURATION) : e.call(this)
            }
        }
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(e && e.length && (b = e.data("bs.tile"), b && b.transitioning))) {
                ...
                if (this.$element.trigger(f), !f.isDefaultPrevented()) {
                    e && e.length && (c.call(e, "hide"), b || e.data("bs.tile", null));
                    var g = this.dimension();
                    ...
                    var h = function () {
                        this.$element.removeClass("collapsing").addClass("collapse in")[g](""), this.transitioning = 0, this.$element.trigger("shown.bs.tile"), this.escape()
                    };
                    if (!a.support.transition) return h.call(this);
                    var i = a.camelCase(["scroll", g].join("-"));
                    this.$element.one("bsTransitionEnd", a.proxy(h, this)).emulateTransitionEnd(d.TRANSITION_DURATION)[g](this.$element[0][i])
    ...
    a.fn.tile = c, a.fn.tile.Constructor = d, a.fn.tile.noConflict = function () {
        return a.fn.tile = e, this
    }, a(document).on("click.bs.tile.data-api", '[data-toggle="tile"]', function (d) {
        var e = a(this);
        if (!a(d.target).is('[data-ignore="tile"], [data-ignore="tile"] *')) {
            e.attr("data-target") || d.preventDefault();
            var f = b(e), g = f.data("bs.tile"), h = g ? "toggle" : e.data();
            c.call(f, h)
        }
    })
}(jQuery), !function (a, b) {
    ...
    function f(a) {
        var c, d, e = {top: 0, left: 0}, f = a && a.ownerDocument;
    ...
    function h(a, b, c, d) {
        if (c) {
            d.classList.remove("waves-wrapping"), c.classList.remove("waves-rippling");
            var e = c.getAttribute("data-x"), f = c.getAttribute("data-y"), h = c.getAttribute("data-scale"),
                i = c.getAttribute("data-translate"), j = Date.now() - Number(c.getAttribute("data-hold")), k = 350 - j;
    ...
    var k = k || {}, l = document.querySelectorAll.bind(document), m = Object.prototype.toString,
        n = "ontouchstart" in window, o = {
            duration: 750, delay: 200, show: function (a, b, c) {
                ...
                var h = f(b), i = 0, j = 0;
                "touches" in a && a.touches.length ? (i = a.touches[0].pageY - h.top, j = a.touches[0].pageX - h.left) : (i = a.pageY - h.top, j = a.pageX - h.left), j = j >= 0 ? j : 0, i = i >= 0 ? i : 0;
                var k = "scale(" + b.clientWidth / 100 * 3 + ")", l = "translate(0,0)";
                ...
                m["-webkit-transition-duration"] = n + "ms", m["-moz-transition-duration"] = n + "ms", m["-o-transition-duration"] = n + "ms", m["transition-duration"] = n + "ms", e.setAttribute("style", g(m))
            }, hide: function (a, b) {
                b = b || this;
    ...
    Waves.attach(".waves-attach"), Waves.init({duration: 600})
});